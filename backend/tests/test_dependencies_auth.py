...
def _mock_request(user: User | None = None) -> Any:
    """Create a MockRequest typed as Any to satisfy pyright with Request parameter."""
...
class TestRequireAuth:
    ...
    async def test_require_auth_missing_state_attribute(self):
        ...
        request: Any = type("MockRequest", (), {})()  # No state attribute
