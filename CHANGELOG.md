...
- Fixed React-hook anti-patterns flagged by `eslint-plugin-react-hooks` 7.1.1 (Setup, ThemeContext, UserAuthenticationCard, useAutoSave)
...
- **@vitejs/plugin-react**: added (^6.0.1)
